...
function TodoEditPage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-xl2 shadow-card space-y-4 bg-white p-6 dark:bg-neutral-800">
        ...
        <input
          ...
          className="focus:ring-brand w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 outline-none focus:ring-2 dark:border-neutral-700 dark:bg-neutral-900"
        />
        <div className="flex items-center gap-2 pt-2">
          <button
            onClick={handleSave}
            className="bg-brand rounded-md px-4 py-2 text-white hover:opacity-90"
          >
            저장
          </button>
          <NavLink
...
function TodoDetailPage() {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="shadow-card space-y-4 rounded-xl bg-white p-6 dark:bg-neutral-800">
